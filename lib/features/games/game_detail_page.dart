...
class _GameDetailPageState extends State<GameDetailPage> {
  late final Future<GameDetailRow?> _future =
      widget.repository.load(widget.gameId);
  ...
  Future<void> _remove() async {
    final confirmed = await showCiConfirmDialog(
      ...
      // block them.
      message: 'This game and its insight will be deleted. Development '
                ...
                children: [
                  ...
                  if (v.showInsight)
                    GameInsightCard(
                      ...
                      onAbout: () => showCiInfoSheet(
                        ...
                        body: 'After each game you log, we write a short read '
                  ...
                  Padding(
                    padding: const EdgeInsets.fromLTRB(
                        CiSpace.screen, CiSpace.s5, CiSpace.screen, CiSpace.s8),
                    child: CiButton(
                      label: 'Remove Game',
...
class _Header extends StatelessWidget {
  const _Header({required this.view, required this.onBack, required this.onShare});
        ...
        return SafeArea(
          ...
          child: Column(
            ...
            children: [
              Padding(
                padding: const EdgeInsets.fromLTRB(
                    CiSpace.screen, CiSpace.s3, CiSpace.screen, CiSpace.s4),
                child: Row(
                  children: [
                    _IconTap(
                      semanticLabel: 'Back',
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    // EQUAL SLOTS, not fixed padding. Five stats beside a
                    // 44pt figure overflowed a 390pt screen by 12px, and
                    // would have been worse on a 360pt Android. Sharing the
                    // remaining width means the row cannot overflow at any
                    // size the app runs at.
                    Expanded(
                      child: Row(
                        children: [
                          for (final m in [
                            ...
                            Expanded(child: _Mini(value: m.$1, label: m.$2)),
                        ],
                      ),
                    ),
                  ],
    ...
    return Expanded(
      child: Padding(
        padding: const EdgeInsets.symmetric(
            horizontal: CiSpace.s4, vertical: CiSpace.s4),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          mainAxisSize: MainAxisSize.min,
          children: [
    ...
    return Center(
      child: Padding(
        ...
        child: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            Text('This game is no longer here',
