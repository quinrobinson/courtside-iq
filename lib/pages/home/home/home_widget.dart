  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      await Future.wait([
        ...
        Future(() async {
          _model.getActiveGames = await GamesTable().queryRows(
            queryFn: (q) => q.eqOrNull(
              'user_id',
              currentUserUid,
            ),
        ...
        Future(() async {
          _model.getUserName = await UsersTable().queryRows(
            queryFn: (q) => q.eqOrNull(
              'id',
              currentUserUid,
            ),
      ...
      _model.revenueCatLogin = await actions.loginToRevenueCat(
        currentUserUid,
      );
      if (_model.revenueCatLogin == true) {
        FFAppState().isUserPremium = true;
        FFAppState().userName = _model.getUserName!.firstOrNull!.firstName!;
        safeSetState(() {});
      } else {
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<VPlayerGameStatsRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<VPlayerGameStatsRow> homeVPlayerGameStatsRowList = snapshot.data!;
                    ...
                    child: SingleChildScrollView(
                      child: Column(
                        ...
                        children: [
                          ...
                          if (_model.getActiveGames!.length > 0)
                            Align(
                          ...
                          Padding(
                            ...
                            child: Builder(
                              builder: (context) {
                                final homeVar =
                                    homeVPlayerGameStatsRowList.toList();
                                if (homeVar.isEmpty) {
                                  return Container(
                                    width: double.infinity,
                                    height: 360.0,
                                        ...
                                        child: Padding(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                                                ...
                                                                Padding(
                                                                  ...
                                                                  child: Row(
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      if (homeVarItem.eventName !=
                                                                              null &&
                                                                          homeVarItem.eventName !=
                                                                              '')
                                                                        Container(
                                                                          height:
                                                                              24.0,
                                                                      ...
                                                                      children: [
                                                                        Flexible(
                                                                          child:
                                                                              Container(
                                                                            height:
                                                                                functions.setStatBar((homeVarItem.offReb!) + (homeVarItem.defReb!))?.toDouble(),
                                                                            decoration:
                                                                                BoxDecoration(
                                                                              color: FlutterFlowTheme.of(context).teal,
                                                                              boxShadow: [
                                                                      ...
                                                                      children: [
                                                                        Flexible(
                                                                          child:
                                                                              Container(
                                                                            height:
                                                                                functions.setStatBar(homeVarItem.assist)?.toDouble(),
                                                                            decoration:
                                                                                BoxDecoration(
                                                                              color: FlutterFlowTheme.of(context).teal,
                                                                              boxShadow: [
                                                                      ...
                                                                      children: [
                                                                        Flexible(
                                                                          child:
                                                                              Container(
                                                                            height:
                                                                                functions.setStatBar(homeVarItem.block)?.toDouble(),
                                                                            decoration:
                                                                                BoxDecoration(
                                                                              color: FlutterFlowTheme.of(context).teal,
                                                                              boxShadow: [
                                                                      ...
                                                                      children: [
                                                                        Flexible(
                                                                          child:
                                                                              Container(
                                                                            height:
                                                                                functions.setStatBar(homeVarItem.steal)?.toDouble(),
                                                                            decoration:
                                                                                BoxDecoration(
                                                                              color: FlutterFlowTheme.of(context).teal,
                                                                              boxShadow: [
                                                                      ...
                                                                      children: [
                                                                        Flexible(
                                                                          child:
                                                                              Container(
                                                                            height:
                                                                                functions.setStatBar(homeVarItem.turnover)?.toDouble(),
                                                                            decoration:
                                                                                BoxDecoration(
                                                                              color: FlutterFlowTheme.of(context).teal,
                                                                              boxShadow: [
                                              ...
                                              if (homeVarItem.gameInsights !=
                                                      null &&
                                                  homeVarItem.gameInsights !=
                                                      '')
                                                Expanded(
                                                  child: Container(
                                                    width: double.infinity,
                          ...
                          if (_model.getActiveGames!.length > 3)
                            Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  12.0, 13.0, 12.0, 12.0),
                              child: Container(
