                      ...
                      Column(
                        ...
                        children: [
                          InkWell(
                            ...
                            onTap: () async {
                              await actions.setDarkModeSystem(
                                context,
                              );
                              FFAppState().darkMode = false;
                              FFAppState().systemMode = true;
                              safeSetState(() {});
                            },
                            child: Container(
                          ...
                          InkWell(
                            ...
                            highlightColor: Colors.transparent,
                            onTap: () async {
                              await actions.setDarkModeOff(
                                context,
                              );
                              FFAppState().darkMode = false;
                              FFAppState().systemMode = false;
                              safeSetState(() {});
                            },
                            child: Container(
                              width: double.infinity,
