...
import 'game_stat_sheet_model.dart';
export 'game_stat_sheet_model.dart';

class GameStatSheetWidget extends StatefulWidget {
  const GameStatSheetWidget({
    super.key,
  ...
  @override
  State<GameStatSheetWidget> createState() => _GameStatSheetWidgetState();
}

class _GameStatSheetWidgetState extends State<GameStatSheetWidget> {
  late GameStatSheetModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GameStatSheetModel());
    ...
    return Padding(
      ...
      child: FutureBuilder<List<VPlayerGameStatsRow>>(
        ...
        builder: (context, snapshot) {
          ...
          List<VPlayerGameStatsRow> containerVPlayerGameStatsRowList =
              snapshot.data!;
                                                              ...
                                                              Expanded(
                                                                child: Padding(
                                                                  ...
                                                                  child: Text(
                                                                    valueOrDefault<
                                                                        String>(
                                                                      containerVPlayerGameStatsRow?.gameInsights != null &&
                                                                              containerVPlayerGameStatsRow?.gameInsights !=
                                                                                  ''
                                                                          ? containerVPlayerGameStatsRow
                                                                              ?.gameInsights
                                                                          : 'None this game.',
                                                                    ...
                                                                    child: Row(
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Column(
                                                                          ...
                                                                          children: [
                                                                            if (functions.ppsaElite(functions.ppsa(
                                                                            ...
                                                                            if (functions.ppsaGood(functions.ppsa(
                                                                                containerVPlayerGameStatsRow!.fgAttempt!,
                                                                                containerVPlayerGameStatsRow!.ftAttempt!,
                                                                                containerVPlayerGameStatsRow?.points)))
                                                                              Container(
                                                                            ...
                                                                            if (functions.ppsaSolid(functions.ppsa(
                                                                                containerVPlayerGameStatsRow!.fgAttempt!,
                                                                                containerVPlayerGameStatsRow!.ftAttempt!,
                                                                                containerVPlayerGameStatsRow?.points)))
                                                                              Container(
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Column(
                                                                          ...
                                                                          crossAxisAlignment:
                                                                              CrossAxisAlignment.end,
                                                                          children: [
                                                                            if (functions.ast2tovElite(containerVPlayerGameStatsRow?.assist,
                                                                                containerVPlayerGameStatsRow?.turnover))
                                                                              Padding(
                                                                                padding: EdgeInsetsDirectional.fromSTEB(0.0, 22.0, 0.0, 0.0),
                                                                                child: Container(
                                                                                  decoration: BoxDecoration(
                                                                            ...
                                                                            if (functions.ast2tovGood(containerVPlayerGameStatsRow?.assist,
                                                                                containerVPlayerGameStatsRow?.turnover))
                                                                              Padding(
                                                                                padding: EdgeInsetsDirectional.fromSTEB(0.0, 22.0, 0.0, 0.0),
                                                                                child: Container(
                                                                            ...
                                                                            if (functions.ast2tovSolid(containerVPlayerGameStatsRow?.assist,
                                                                                containerVPlayerGameStatsRow?.turnover))
                                                                              Container(
                                                                                decoration: BoxDecoration(
                                                                                  color: FlutterFlowTheme.of(context).gray4,
                                                                  ...
                                                                  child: Column(
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      Text(
                                                                        ' (${valueOrDefault<String>(
                                                                          formatNumber(
                                                                            functions.calculatePlayerThreePointPercent(containerVPlayerGameStatsRow?.threeMade,
                                                                                containerVPlayerGameStatsRow?.threeAttempt),
                                                                            formatType:
                                                                                FormatType.custom,
                                                                            format:
                                                                                '00',
                                                                ...
                                                                child: Column(
                                                                  ...
                                                                  children: [
                                                                    Text(
                                                                      valueOrDefault<
                                                                          String>(
                                                                        ((containerVPlayerGameStatsRow!.offFoul!) +
                                                                                (containerVPlayerGameStatsRow!.defFoul!))
                                                                            .toString(),
                                                                        '0',
                                                                      ),
                                                                      textAlign:
                                                                    ...
                                                                    Text(
                                                                      valueOrDefault<
                                                                        ...
                                                                        functions
                                                                            .calculateEFF(
                                                                                containerVPlayerGameStatsRow?.points,
                                                                                containerVPlayerGameStatsRow?.offReb,
                                                                                containerVPlayerGameStatsRow?.defReb,
                                                                                containerVPlayerGameStatsRow?.assist,
                                                                                containerVPlayerGameStatsRow?.steal,
                                                                                containerVPlayerGameStatsRow?.block,
                                                                                containerVPlayerGameStatsRow?.fgAttempt,
                                                                                containerVPlayerGameStatsRow?.fgMade,
                                                                                containerVPlayerGameStatsRow?.ftAttempt,
                                                                                containerVPlayerGameStatsRow?.ftMade,
                                                                                containerVPlayerGameStatsRow?.turnover)
                                                                            .toString(),
                                                                        '0',
                                                                      ),
                                  ...
                                  onPressed: () async {
                                    await Share.share(
                                      functions.stat2text(
                                          ...
                                          containerVPlayerGameStatsRow!
                                              .threeMade!,
                                          '${containerVPlayerGameStatsRow?.firstName} ${containerVPlayerGameStatsRow?.lastName}')!,
                                      sharePositionOrigin:
